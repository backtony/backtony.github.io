...
---
### 단방향
![그림1](https://backtony.github.io/assets/img/post/jpa/start/5-1.PNG)
...
### 양방향
![그림2](https://backtony.github.io/assets/img/post/jpa/start/5-2.PNG)
...
![그림3](https://backtony.github.io/assets/img/post/jpa/start/5-3.PNG)
+ 일대다 중 일이 연관관계의 주인
+ 테이블에는 항상 다쪽에 외래 키가 있기에 객체기준에서 보면 반대편 테이블의 외래 키를 관리하는 특이한 구조
+ 일에 @OneToMany, @JoinColumn
+ @JoinColumn 반드시 사용, 사용 하지 않으면 조인 테이블 방식으로 중간에 테이블이 추가됨

<br>

### 양방향
![그림4](https://backtony.github.io/assets/img/post/jpa/start/5-4.PNG)
...
+ 외래 키에 데이터베이스 유니크 제약조건을 추가해줘야 한다. -> 외래 키로 지정하는 id값의 속성으로 unique = true로 주면 된다.

<br>

### 주 테이블 외래 키 단방향
![그림5](https://backtony.github.io/assets/img/post/jpa/start/5-5.PNG)
...
### 주 테이블 외래 키 양방향
![그림6](https://backtony.github.io/assets/img/post/jpa/start/5-6.PNG)
...
### 대상 테이블 외래 키 단방향
![그림7](https://backtony.github.io/assets/img/post/jpa/start/5-7.PNG)

일대다에서 사용했던 것이라고 보면 된다. 하지만 일대일에서는 이런 관계가 성립되지 않는다. 일대일 관계는 자신의 객체만이 자신의 테이블을 관리할 수 있다고 생각하면 된다. 

<br>

### 대상 테이블 외래 키 양방향
![그림8](https://backtony.github.io/assets/img/post/jpa/start/5-8.PNG)
...
## 4. 다대다
---
![그림9](https://backtony.github.io/assets/img/post/jpa/start/5-9.PNG)

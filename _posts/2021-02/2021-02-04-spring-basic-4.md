...
어노테이션을 만들어서 BeanA 클래스에는 MyIncludeComponent 어노테이션을 만들어서 붙이고, BeanB에는 MyExcludeComponent어노테이션을 만들어서 붙였다는 가정하에 테스트 코드를 작성해보자.
```java
...
![그림3](https://backtony.github.io/assets/img/post/spring/basic/4-3.PNG)

---
layout: post
title:  JPA 기본 - 객체지향 쿼리 언어 JPQL - 1
subtitle:   JPA 기본 - 객체지향 쿼리 언어 JPQL - 1 
categories: jpa
tags: start
comments: true
# header-img:
...
+ __목차__
  - [1. JPQL](#1-JPQL)    
  - [2. 기본 문법](#2-기본-문법)    
  - [3. 결과 조회 API](#3-결과-조회-api)    
  - [4. 프로젝션](#4-프로젝션)    
  - [5. 페이징](#5-페이징)    
  - [6. 조인](#6-조인)    
  - [7. 서브 쿼리](#7-서브-쿼리)    
  - [8. JPQL 타입 표현과 기타식](#8-jpql-타입-표현과-기타식)    
  - [9. 조건식](#9-조건식)    
  - [10. 함수](#10-함수)    
...
### 사용자 정의 함수
![그림9](https://backtony.github.io/assets/img/post/jpa/start/9-1.PNG)
